...
var UpdateUserAvatarService = /** @class */ (function () {
    ...
    UpdateUserAvatarService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var usersRepository, user, userAvatarFilePath, userAvatarFileExists, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        usersRepository = typeorm_1.getRepository(User_1.default);
                        return [4 /*yield*/, usersRepository.findOne(userId)];
                    case 1:
                        user = _b.sent();
                        if (!user) {
                            throw new AppError_1.default('Apenas usuários autenticados podem mudar o avatar', 401);
                        }
                        if (!user.avatar) return [3 /*break*/, 7];
                    ...
                    case 3:
                        ...
                        if (!userAvatarFileExists) return [3 /*break*/, 5];
